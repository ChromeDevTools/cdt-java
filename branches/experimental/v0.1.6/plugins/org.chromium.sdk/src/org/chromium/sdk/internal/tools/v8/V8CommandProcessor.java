...
public class V8CommandProcessor implements V8CommandSender<DebuggerMessage, RuntimeException> {
  ...
  private void reportVmStatus() {
    ...
    // We synchronize, because we one thread may be delivering obsolete message while more
    // recent has already been delivered.
  ...
  private static class CallbackEntry {
    ...
    CallbackEntry(V8HandlerCallback v8HandlerCallback, SyncCallback syncCallback, String requestName) {
