...
import org.chromium.debug.core.tools.v8.SeqGenerator;
 ...
 */
public class V8DebugRequestMessage implements JSONStreamAware {
  ...
  public V8DebugRequestMessage(String command) {
  ...
  public void writeJSONString(Writer out) throws IOException {
    ...
    obj.put("seq", sequence); //$NON-NLS-1$
    obj.put("type", V8MessageType.REQUEST.value); //$NON-NLS-1$
    obj.put("command", command); //$NON-NLS-1$
    if (!arguments.isEmpty()) {
      obj.put("arguments", arguments); //$NON-NLS-1$
    }
