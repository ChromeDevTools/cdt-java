...
public abstract class JsEvaluateContextImpl implements JsEvaluateContext {
        ...
        : new V8CommandProcessor.V8HandlerCallback() {
          public void messageReceived(CommandResponse response) {
            ...
            if (successResponse != null) {
              ...
              JsVariable variable =
                  new JsVariableImpl(JsEvaluateContextImpl.this.getInternalContext(), V8Helper.createMirrorFromLookup(
