 ...
 * from elsewhere).
 */
class WipDialogBasedSelector implements JavascriptVmEmbedderFactory.WipTabSelector {
  static final WipDialogBasedSelector INSTANCE = new WipDialogBasedSelector();

  private static final int DEFAULT_TAB_ID = 2;

  @Override
  public TabConnector selectTab(WipBrowser browser) {
