 ...
 * synchronized together: their selection, expansion and scroll position is repeated in each other.
 */
public class LiveEditDiffViewer {
  ...
  /**
   * A static parameter for the viewer. They do not change.
   */
  ...
  public interface FunctionNode {
    ...
    /**
     * @param side a version of the script -- old or new
  ...
  /**
   * A monitor that helps cross tree synchronization. Changes in one tree are propagated to
   * another one, but this monitor helps block a recursive propagation.
   */
